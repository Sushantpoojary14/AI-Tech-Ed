  ...
  return (
    <>
      <Stack direction="row" useFlexGap flexWrap="wrap">
       {( location.pathname==='/user/Test-result-analysis/view/1' || location.pathname==='/user/Test-result-analysis/solution/1') && 
        <Link to="/user/Test-result-analysis">
        <BButton name={<><ReplyIcon sx={{ width: '18px', height: '18px',m:'auto', }} /> 
        <Typography sx={{color:'#FFFFFF',m:'auto'}}>GO BACK</Typography></>} 
        css={{borderRadius:'3px', width: '143px', height: '34px',m:'18px',pl:'5px' }} />
        </Link>}
