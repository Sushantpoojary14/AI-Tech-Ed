...
if(isLoading){
  ...
  return (
    <Container maxWidth="xl" sx={{ display: 'grid', gridTemplateColumns: {lg:'auto auto auto auto auto',md:'auto auto auto ',sm:'auto auto ',xs:'auto'},gridGap: {lg:'20px',md:'20px',sm:'20px',xs:'20px'},my:'30px' }}>
      {card_content.map((item:content) => {
        return (<Card sx={{
          ...
          <CardContent sx={{ width: '239px', m: 'auto',textAlign:'center' }}>
            <Header1 header={item.title} css={{ mx:'auto', width:'151px',my:'5px'}} />
            <Stack direction="row" sx={{ width: '192px', height: '60px', fontWeight: '400', m: 'auto' }}>
              <Item1><Header2 header={item.name} />
                <Typography sx={{ fontSize: '9px', m: 0 }}>CUSTOM EXAMS</Typography>
              </Item1>
              <Item2><Header2 header={item.name} />
