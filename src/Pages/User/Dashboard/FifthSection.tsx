...
const header = ['Test name', 'Subject', 'Marks Scored', 'Percentage', 'Test date', 'Rank'];
const tableData = [
  { name: 'test1', subject: 'Maths', marks_scored: '200', percentage: '75%', test_date: '29/12/2022', rank: '1' },
  { name: 'test2', subject: 'Maths-2', marks_scored: '100', percentage: '55%', test_date: '29/12/2022', rank: '9' },
  { name: 'test2', subject: 'Maths-2', marks_scored: '100', percentage: '55%', test_date: '29/12/2022', rank: '9' }];
