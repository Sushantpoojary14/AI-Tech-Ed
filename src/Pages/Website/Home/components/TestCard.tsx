...
const TestCard = (props: props) => {
    ...
    return (
        <Card sx={{ width: {lg:'415px' ,md:'415px', sm:'355px',xs:'355px'}, height: {lg:'485px', sm:'490px' ,xs:'485px', md:'490px'}, border: '1px solid #ccc', borderRadius: '3px', p: { lg:'25px',md: '10px', sm: '15px', xs: '25px' }, boxShadow: '13px 13px 20px 1px rgba(0, 0, 0, 0.16)', mb: '30px', mx: 'auto' }} >
            <CardMedia
