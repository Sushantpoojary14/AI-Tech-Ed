...
const data = [
  {
    q: " 1. What is the purpose of an online OC and Selective Tests shop?",
  ...
  {
    q: " 2. What types of materials are available in the online Portal?",
  ...
  {
    q: " 3. How can I access the materials after purchase?",
  ...
  {
    q: "4. Are the practice tests and materials aligned with OC and Selective test formats?",
  ...
  {
    q: " 5. WCan I get a refund if I am not satisfied with the purchased materials?",
  ...
  {
    q: " 6. Are there different packages or bundles available for purchase?",
  ...
  {
    q: " 7. Is technical support available if I encounter issues with accessing the materials?",
  ...
  {
    q: " 8. How can I stay informed about updates, promotions, and new materials?",
  ...
  {
    q: " 9. What is the validity period of the purchased online test materials?",
  ...
  {
    q: " 10. Can I access the online tests after the expiration of the validity period?",
  ...
  {
    q: " 11. Are there options to extend the validity of the online tests if needed?",
