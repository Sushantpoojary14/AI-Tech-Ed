...
const ProfileComponent = (props:props) => {
  return (
    ...
    <Container maxWidth="xl">
        <Card sx={{
            boxShadow: '6px 6px 20px 0px #808080', my: '15px', display: 'flex', flexDirection: { lg: 'row', md: 'row', sm: 'row', xs: 'column' },
            ...
            <Box>
                ...
                {props.details?.map((item: Detail, key:number) => {
                    ...
                    return <Stack flexDirection="row" sx={{ alignItems: 'center', width: { lg: '500px', md: '500px', sm: '500px', xs: '300px' }, justifyContent: 'space-between' }} margin="20px" marginBottom="50px" key={key}>
            ...
            <OButton name="Edit" css={{ width: '140px', m: '20px' }} func={props.func} />
        </Card>
    </Container>
</>
  )
